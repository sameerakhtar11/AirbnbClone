...
function Login() {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-rose-50 via-white to-rose-100 flex items-center justify-center p-4 relative overflow-hidden font-sans'>
            ...
            <div className='absolute -bottom-20 -right-20 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000'></div>
            ...
            <div className='w-full max-w-md bg-white/70 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 md:p-10 relative z-10 animate-fade-in-up'>
                ...
                <form className='space-y-6' onSubmit={handleLogin}>
                    ...
                    <div className='flex justify-end'>
                        <span className='text-sm text-primary-600 font-semibold hover:underline cursor-pointer transition-colors hover:text-primary-700'>Forgot password?</span>
                    </div>

                    <button
                        className='w-full py-3.5 rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 text-white font-bold text-lg shadow-lg shadow-primary-500/30 hover:shadow-xl hover:scale-[1.02] transition-all transform active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed'
                        disabled={loading}
                    >
                        {loading ? (
                    ...
                    <div className='relative my-6'>
                        ...
                        <div className='relative flex justify-center text-sm'><span className='px-4 bg-transparent bg-white/0 backdrop-blur-xl text-gray-500 font-medium'>Or continue with</span></div>
                    </div>
                    ...
                    <p className='text-center text-gray-600 mt-6'>
                        Don't have an account? <span className='text-primary-600 font-bold hover:underline cursor-pointer transition-colors hover:text-primary-700' onClick={() => navigate("/signup")}>Sign up</span>
                    </p>
                </form>
            </div>
        </div>
